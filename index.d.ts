...
declare namespace Rodux {
	...
	interface StoreCreator {
		...
		new <S, A extends Action, Ext1>(
			reducer: Reducer<S, A>,
			preloadedState?: DeepPartial<S>,
			middleware?: [Middleware<Ext1, Store<S, A>>],
		...
		new <S, A extends Action, Ext1, Ext2>(
			reducer: Reducer<S, A>,
			preloadedState?: DeepPartial<S>,
			middleware?: [Middleware<Ext1, Store<S, A>>, Middleware<Ext2, Store<S, A>>],
		...
		new <S, A extends Action, Ext1, Ext2, Ext3>(
			...
			preloadedState?: DeepPartial<S>,
			middleware?: [
				Middleware<Ext1, Store<S, A>>,
				Middleware<Ext2, Store<S, A>>,
				Middleware<Ext3, Store<S, A>>,
			],
